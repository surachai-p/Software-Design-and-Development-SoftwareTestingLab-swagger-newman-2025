...
4. แก้ไข Swagger และ Newman เพื่อทดสอบการทำงาน
   ...
   ![alt text](images/ข้อ4.1.png)
   บันทึกรูปผลการทำงานของ newman 
   
   ![alt text](images/ข้อ4.2.png)
...
```
คำตอบ:
Swagger UI ใช้สำหรับทำเอกสารและทดสอบยิง API ทีละจุดด้วยตัวเอง ในขณะพัฒนาเพื่อให้เห็นภาพรวมข้อมูล ส่วน Newman ใช้สำหรับรันชุดทดสอบอัตโนมัติ (Automation) ทั้งระบบพร้อมกันผ่าน Command Line เพื่อตรวจสอบความถูกต้องซ้ำๆ และออกรายงานผลการเทส
```
...
```
คำตอบ:
การ ดึงแม่แบบข้อมูล ที่นิยามไว้ในส่วนกลางมาใช้ครับ มีประโยชน์คือช่วยให้ไม่ต้องเขียน Code ซ้ำซ้อน และเมื่อมีการแก้ไขโครงสร้างข้อมูลก็สามารถแก้ที่เดียวแล้วอัปเดตทุก API พร้อมกันทันที ทำให้ Code สะอาดและลดโอกาสผิดพลาด
```
...
ผลที่ควรระวัง: การค้างของข้อมูล เช่น หากรอบแรกมีการลบหรือแก้ไขข้อมูลไปแล้ว รอบต่อๆ ไปอาจรันไม่ผ่านเพราะหาข้อมูลเดิมไม่เจอ หรือการรันสร้างข้อมูลซ้ำๆ อาจทำให้ข้อมูลเต็มหรือติด Error
```
...
```
คำตอบ:
ควรเขียน Swagger พร้อมหรือก่อนเขียน Code (API-First Design) เพื่อเป็นพิมพ์เขียวในการตกลงรูปแบบข้อมูลกับทีมให้ตรงกัน ส่วน Newman ควรรัน ทุกครั้งหลังมีการแก้ไข Code หรือก่อนส่งงาน เพื่อตรวจสอบว่าฟังก์ชันใหม่ที่เขียนเพิ่มไม่ไปทำให้ระบบเดิมพัง และเพื่อให้มั่นใจว่า API ทุกตัวยังทำงานถูกต้อง
```
